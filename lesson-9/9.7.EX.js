...
const port = 3000;// @TODO: express 모듈을 가져온다
const express = require('express');// @TODO: homeController 모듈을 가져온다
const homeController = require('./controllers/homeController');// @TODO: 포트 번호를 지정한다
